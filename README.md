...
<p align="center">
	...
	<!--a href="https://github.com/cyrezdev/a11y-apca-sass/releases/download/0.1.0-beta/a11y-apca-sass-0.1.0-beta.zip" alt="Download latest version of A11y APCA Sass"><img alt="A11y APCA Sass Library all releases" src="https://img.shields.io/github/downloads/cyrezdev/a11y-apca-sass/total?style=for-the-badge&label=Downloads&color=orange"></a-->
	<a href="https://github.com/cyrezdev/a11y-apca-sass/releases/download/0.1.0-beta/a11y-apca-sass-0.1.0-beta.zip" alt="Download latest version of A11y APCA Sass">
		<img alt="GitHub all releases" src="https://img.shields.io/github/downloads/cyrezdev/a11y-apca-sass/total?style=for-the-badge&label=Downloads%20%5B%E2%87%A9%5D&color=orange">
	</a>
	<!--img alt="A11y APCA Sass Library all releases" src="https://img.shields.io/github/downloads/cyrezdev/a11y-apca-sass/latest/total?style=for-the-badge&label=Downloads&color=orange"-->
	<!--img alt="A11y APCA Sass Library 0.1.0-beta" src="https://img.shields.io/github/downloads/cyrezdev/a11y-apca-sass/0.1.0-beta/total?style=for-the-badge&label=Downloads%200.1.0&color=orange&sort=semver"-->
</p>
...
Code copyright 2023-2024 [Cyril Reze](https://cyrez.dev). Code released under the [MIT License](https://github.com/cyrezdev/a11y-apca-sass/blob/main/LICENSE).
